...
var Pantalla = {		
	...
	HumanList: [], carLowList: [], RangeList: [], obstacleList: [],
	raycaster: null,
...
function update() {
	...
	//Translate bodies:
	for (var i = 0; i < Pantalla.coneList.length; i++) {
		Pantalla.coneList[i].position.z += this.WALK_SPEED;
	}
	
	//Calculate collisions:
	//	
	
	if (Pantalla.cotxe != null) {
		if (Pantalla.collision()) {
			console.log("He colisionat!");
		}
	}
