var World = Class.extend({
    ...
    init: function(args) {
		...
		// Set and add the roof
		var roof = new THREE.PlaneGeometry(512, 1024),
                height = 128,
                walls = [
                    new THREE.PlaneGeometry(roof.height, height),
                    new THREE.PlaneGeometry(roof.width, height),
                    new THREE.PlaneGeometry(roof.height, height),
                    new THREE.PlaneGeometry(roof.width, height)
                ],
                obstacles = [
        ...
        this.mesh = new THREE.Object3D();
        // Set and add the roof
        this.roof = new THREE.Mesh(roof, material);
